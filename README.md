...
- **Análise Semântica por Bigramas**: A IA extrai o texto utilizando TF-IDF configurado para capturar expressões combinadas (ex: "Machine Learning", "React Native", "Data Science") em vez de palavras soltas. Isso preserva o contexto técnico real e elimina falsos positivos na triagem.
...
└── src/
    ...
    ├── train_production.py # NOVO: Script do pipeline de ML para processar texto e treinar o Random Forest
